...
export class Turbina extends THREE.Group {
  ...
  constructor() {
    ...
    const silverTexture = loader.load( 'texture/silver.jpg' );
    this.silverMaterial = new THREE.MeshPhongMaterial ( { map: silverTexture } );

    const redMetalTexture = loader.load( 'texture/redMetal.png' );
    this.redMetalMaterial = new THREE.MeshPhongMaterial ( { map: redMetalTexture } );


    const cobaltTexture = loader.load( 'texture/cobalt.jpg' );
    cobaltTexture.wrapS = cobaltTexture.wrapT = THREE.RepeatWrapping;
    cobaltTexture.repeat.set( 5, 5 );
    cobaltTexture.anisotropy = 16;
    this.cobaltMaterial = new THREE.MeshPhongMaterial ( { map: cobaltTexture } );
    this.cobaltMaterial2 = new THREE.MeshPhongMaterial ( { map: cobaltTexture } );
    ...
    this.undergroundSpotLight = new THREE.SpotLight(eolicColor);
