...
var cylinderMaterial3 = new THREE.MeshPhongMaterial( {color:'rgb(100,100,255)'} );
...
var cylinderMaterial4 = new THREE.MeshPhongMaterial( {color:'rgb(100,100,255)'} );
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    // Will execute R3, T2, R2, T1 and R1 in this order
    cylinder3.matrix.multiply(mat4.makeTranslation(0.0, 1.0, 0.0)); // T1
    ...
    cylinder3.matrix.multiply(mat4.makeTranslation(0.0, 0.0, 0.5)); // T2

    // Will execute R3, T2, R2, T1 and R1 in this order
    cylinder4.matrix.multiply(mat4.makeTranslation(0.0, -1.0, 0.0)); // T1
    ...
    cylinder4.matrix.multiply(mat4.makeTranslation(0.0, 0.0, -0.5)); // T2
...
function buildInterface()
{
  ...
  gui.add(controls, 'speed', 0.00, 0.5)
